...
void tokenizer(Script *script, bool update, bool increae_line, int nbMaxTokenToRead)
{
    ...
    while (script->nextChar() != EOF_TEXT and nbReadToken < nbMaxTokenToRead)
    {
        ...
        if (c == '=')
        {
            ...
            if (c2 == '=')
            {
                Token t=Token(TokenDoubleEqual,EOF_VARTYPE);
               // t._vartype = NULL;
            ...
            else
            {
              ...
              //  t.type = TokenEqual;
              //  t.line = _token_line;
                Token t=Token(TokenEqual,EOF_VARTYPE,_token_line);
                // t.pos = pos;
                if (_for_display)
                    t.addText ("=");
                 _tks.push( t);
        ...
        if (c == '<')
        {
            ...
            if (c2 == '=')
            {
               // token t;
                ...
                //t.type = TokenLessOrEqualThan;
                 ...
                 Token t=Token(TokenLessOrEqualThan,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText( "<=");
               // t.line = _token_line;
                // t.pos = pos;
            ...
            else if (c2 == '<')
            {
              ...
              //  t.type = TokenShiftLeft;
                 Token t=Token(TokenShiftLeft,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText("<<");
                //t.line = _token_line;
                // t.pos = pos;
        ...
        if (c == '>')
        {
            ...
            if (c2 == '=')
            {
              ...
              //  t._vartype = NULL;
               // t.type = TokenMoreOrEqualThan;
                 Token t=Token(TokenMoreOrEqualThan,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText( ">=");
               // t.line = _token_line;
                // t.pos = pos;
            ...
            else if (c2 == '>')
            {
               ...
               // t._vartype = NULL;
                //t.type = TokenShiftRight;
                 Token t=Token(TokenShiftRight,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText(">>");
               // t.line = _token_line;
                // t.pos = pos;
            ...
            else
            {
               ...
               // t.line = _token_line;
                Token t=Token(TokenMoreThan,EOF_VARTYPE,_token_line);
                // t.pos = pos;
                if (_for_display)
                    t.addText ( ">");
               // _tks.push(t);
        ...
        if (c == '!')
        {
            ...
            if (c2 == '=')
            {
                ...
                Token t=Token(TokenNotEqual,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText( "!=");
               // t.line = _token_line;
                // t.pos = pos;
            ...
            else
            {
              ...
              //  t._vartype = NULL;
               // t.type = TokenNot;
               // t.line = _token_line;
                 Token t=Token(TokenNot,EOF_VARTYPE,_token_line);
                // t.pos = pos;
                if (_for_display)
                    t.addText( "!");
               // _tks.push(t);
            ...
            if (c2 == '+')
            {
               // token t;
                ...
                //t.type = TokenPlusPlus;
                 Token t=Token(TokenPlusPlus,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText( "++");
               // t.line = _token_line;
                // t.pos = pos;
            ...
            else
            {
               ...
               // t._vartype = NULL;
                //t.type = TokenAddition;
                 Token t=Token(TokenAddition,EOF_VARTYPE,_token_line);
                if (_for_display)
                    t.addText("+");
               // t.line = _token_line;
                // t.pos = pos;
        ...
        if (c == ';')
        {
           ...
           // t._vartype = NULL;
            Token t=Token(TokenSemicolon,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText(";");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '\t')
        {
           ...
           // t.type = TokenSpace;
           // t._vartype = NULL;
             Token t=Token(TokenSpace,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText("\t");
            //t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '&')
        {
           ...
           // t._vartype = NULL;
             Token t=Token(TokenUppersand,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText( "&");
            //t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '#')
        {
            ...
            //t.type = TokenDiese;
            //t._vartype = NULL;
             Token t=Token(TokenDiese,EOF_VARTYPE,_token_line);
            if (_for_display)
            {
                t.addText( "#");
                          // _tks.push(t);
        ...
        if (c == '(')
        {
           // token t;
            ...
            //t._vartype = NULL;
             Token t=Token(TokenOpenParenthesis,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText("(");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '%')
        {
           ...
           // t.type = TokenModulo;
            //t._vartype = NULL;
             Token t=Token(TokenModulo,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText("%");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == ')')
        {
          //  token t;
           ...
           // t._vartype = NULL;
             Token t=Token(TokenCloseParenthesis,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText(")");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '{')
        {
           ...
           // t._vartype = NULL;
             Token t=Token(TokenOpenCurlyBracket,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText("{");
            //t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '}')
        {
           ...
           // t._vartype = NULL;
             Token t=Token(TokenCloseCurlyBracket,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText( "}");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == '[')
        {
          //  token t;
           ...
           // t._vartype = NULL;
            Token t=Token(TokenOpenBracket,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText( "[");
           // t.line = _token_line;
            // t.pos = pos;
        ...
        if (c == ']')
        {
           ...
           // t._vartype = NULL;
             Token t=Token(TokenCloseBracket,EOF_VARTYPE,_token_line);
            if (_for_display)
                t.addText("]");
            t.line = _token_line;
            // t.pos = pos;
  ...
  //  t.line = _token_line;
    ...
    if (script->currentChar() == EOF_TEXT)
    {
        ...
        { // printf("oinr termine");
          ...
          Token t=Token(TokenEndOfFile,EOF_VARTYPE,_token_line);
           // _tks.push(t);
           _tks.push(t);
        }
    }
...
string formatLine(string str)
{
    ...
    while (_tks.current()->getType() != TokenEndOfFile) // for (int i = 0; i < _tks.size(); i++)
    {
        ...
        {
            _prevbracket++;
            res = res + string_format("%s%s", _colors[_bracket.size() % _NB_COLORS], tk.getText());
